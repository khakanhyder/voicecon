...
CONNECTORS = [
    ...
    {"slug": "hubspot",           "name": "HubSpot",              "category": "crm",           "auth_type": "oauth2",  "description": "CRM contacts, deals, and pipeline management",                       "base_url": "https://api.hubapi.com",            "auth_config": {"oauth_url": "https://app.hubspot.com/oauth/authorize", "token_url": "https://api.hubapi.com/oauth/v1/token", "scopes": ["oauth", "crm.objects.contacts.read", "crm.objects.contacts.write", "crm.objects.deals.read", "crm.objects.deals.write"], "test_endpoint": "/crm/v3/objects/contacts"}, "rate_limit_per_minute": 100},
