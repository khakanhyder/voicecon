    ...
    pages: [
      {
        ...
        keywords: [
          'builder', 'canvas', 'automation', 'flow', 'nodes', 'graph',
          'validation', 'errors', 'warnings', 'unsupported step', 'code node',
          'retired', 'cycle', 'loop error',
        ],
      },
      {
        title: 'Triggers',
        ...
        keywords: [
          'cron', 'cron_expression', 'interval', 'one_time', 'schedule', 'webhook',
          'webhook_key', 'allowed_ips', 'event', 'call_completed', 'call_started',
          'filters', 'inputs', 'utc', 'timezone',
        ],
      },
      {
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        keywords: [
          'webhook', 'http', 'integration', 'action', 'run tool', 'api',
          'tool picker', 'tool id', 'status_code', 'ok', 'json', 'response',
        ],
      },
      {
        title: 'AI Node',
    ...
    pages: [
      {
        ...
        keywords: [
          'function calling', 'tool', 'create tool', 'assign', 'test',
          'test result', 'status_code', 'ok', 'response', 'simulated',
        ],
      },
      {
      ...
      },
      {
        ...
        keywords: [
          'api request', 'custom tool', 'mcp', 'slack', 'google sheets',
          'google calendar', 'gohighlevel', 'connected integration', 'webhook',
          'bearer', 'basic auth', 'custom header', 'headers', 'body template',
          'timeout', 'ssrf', 'legacy', 'status_code',
        ],
      },
    ],
  },
    ...
    pages: [
      ...
      },
      {
        ...
        sections: [
          ...
          { id: 'storage', title: 'File and object storage' },
        ...
        keywords: [
          ...
          'twilio', 'telnyx', 'vonage', 'calendly', 'cal.com', 'google',
          'google sheets', 'google drive', 'google calendar', 'supabase',
          'langfuse', 's3', 'aws', 'cloudflare r2', 'gcs', 'azure blob',
          'storage', 'bucket', 'recordings', 'catalog', 'connectors',
        ],
      },
    ],
  },
    ...
    pages: [
      ...
      },
      {
        ...
        keywords: [
          ...
          'team', 'workspace', 'ownership', 'rename workspace', 'delete workspace',
          'leave workspace', 'workspace id', 'slug', 'danger zone',
        ],
      },
      {
        title: 'API Keys',
      ...
      },
      {
        ...
        sections: [
          ...
          { id: 'deactivating', title: 'Deactivating your account' },
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        keywords: [
          'troubleshooting', 'errors', 'debug', 'not working', 'help', 'fix',
          'unsupported step', 'code node', 'webhook url rejected', 'not found',
          'no value to work on', 'action is not available', 'retries', 'dead air',
          'cron wrong hour', 'webhook never fires', 'not valid json', 'headers',
          'body template', '401', 'unauthorized', 'placeholder', 'silent success',
          'connected integration', 'timed out',
        ],
      },
    ],
  },
