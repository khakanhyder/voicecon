...
import { FieldMapField } from './fields/FieldMapField'
  ...
  return (
    <div className="space-y-2">
      ...
      {field.type === 'connection' ? (
        ...
        <FieldMapField value={value as any} onChange={onChange} />
      ) : field.type === 'calculations' ? (
        <CalculationsField value={value as any} onChange={onChange} />
      ) : field.type === 'textarea' ? (
        <ExpressionInput
          id={id}
          multiline
